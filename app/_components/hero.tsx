      ...
      <div className="grid xl:grid-cols-5 grid-cols-1 items-center relative">
        ...
        <div className="relative xl:col-span-2 p-6 xl:p-0 xl:-me-24 xl:mt-0 -mt-24 z-10 order-2 xl:order-none">
          ...
          >
            ...
            <SwiperSlide>
              <div className="max-w-xl border mx-auto xl:ms-auto xl:me-0 rounded-xl bg-default-100 dark:bg-default-50">
                <div className="p-6">
                  <div className="flex-col flex items-start justify-end xl:h-full">
          ...
          >
            <SwiperSlide>
              <div className="relative">
                <img src="https://i.ibb.co/1qfg6zJ/DSC-0834-compressed-1.jpg" className="  h-96 object-cover w-full" />
            ...
            <SwiperSlide>
              <div className="relative">
                <img src="https://i.ibb.co/cknvsfg/Photo-6-group-work-compressed.jpg" className=" h-96 object-cover w-full" />
                <div className="absolute inset-0 bg-black/25"></div>
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide>
              <div className="relative">
                <img src="https://i.ibb.co/7V5DN97/DSC-0789-compressed.jpg" className=" h-96 object-cover w-full" />
                <div className="absolute inset-0 bg-black/25"></div>
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="relative">
                <img src="https://i.ibb.co/Ld3YN09/DSC6247-compressed.jpg" className=" h-96 object-cover w-full" />
                <div className="absolute inset-0 bg-black/25"></div>
              </div>
            </SwiperSlide>
          </Swiper>
